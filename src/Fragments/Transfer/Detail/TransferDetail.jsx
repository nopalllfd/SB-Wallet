        ...
        <Modal open={isSuccessModalOpen} onClose={handleCloseSuccessModal}>
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Transfer Success</h2>
            </div>
            <p className="text-sm text-gray-600">
              Transfer ke <span className="font-semibold text-gray-900">{successInfo?.toName}</span> berhasil.
            </p>
            <p className="text-sm text-gray-600">
              Nominal: <span className="font-semibold text-gray-900">{successInfo?.amount}</span>
            </p>
            <div className="pt-3">
              <Button buttonColor="bg-blue-700" buttonTextColor="text-white" className="rounded-md" onClick={handleCloseSuccessModal}>
                Back to Transfer
              </Button>
            </div>
          </div>
